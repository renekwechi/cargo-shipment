        ...
        <>
            <div className="bg-image">
                <div className="container text-light">
                    <div className="pt-3 text-center" data-aos="bounce-in">
                        <h1 className='fw-bold' style={{ fontSize: '7vmin', marginTop: '120px' }}>
            ...
            <div className="container">
                <div className="text-center">
                    ...
                    <p className='pt-2'>Crystal Shipment is more than logistics. We can also optimize your packaging,
                        manage your materials sourcing, and so much more.</p>
                </div>
                <div className="row mt-5">
                    <div className="col-md-6" data-aos="fade-up">
                        <img src={About} alt="" className='img-fluid rounded mb-5' />
                    </div>
                    <div className="col-md-6" data-aos="fade-up">
